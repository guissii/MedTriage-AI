...
import { OverviewSection as AdminOverview } from '@/sections/admin/OverviewSection';
import { ManageDoctorsSection } from '@/sections/admin/ManageDoctorsSection';
import { SystemLogsSection } from '@/sections/admin/SystemLogsSection';
import { AIUsageStatsSection } from '@/sections/admin/AIUsageStatsSection';
import { DrugDatabaseSection } from '@/sections/admin/DrugDatabaseSection';
import { ReferenceRangesSection } from '@/sections/admin/ReferenceRangesSection';
import { getInitials } from '@/lib/utils';

type AdminView = 'overview' | 'doctors' | 'logs' | 'ai-stats' | 'drugs' | 'references' | 'settings';
...
export function AdminDashboard() {
  ...
  const navItems = [
    ...
    { id: 'doctors' as AdminView, label: 'Manage Doctors', icon: Users },
    { id: 'logs' as AdminView, label: 'System Logs', icon: FileText },
    { id: 'ai-stats' as AdminView, label: 'AI Usage Stats', icon: BarChart3 },
    { id: 'drugs' as AdminView, label: 'Drug Database', icon: Database },
    { id: 'references' as AdminView, label: 'Reference Ranges', icon: ActivityIcon },
  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case 'doctors':
        return <ManageDoctorsSection />;
      case 'logs':
        return <SystemLogsSection />;
      case 'ai-stats':
        return <AIUsageStatsSection />;
      case 'drugs':
        return <DrugDatabaseSection />;
      case 'references':
        return <ReferenceRangesSection />;
      case 'settings':
